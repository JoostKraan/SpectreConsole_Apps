...
namespace SpectreRPG
{
    public class Game
    {
        ...
        public void InputPlayerInfo()
        {
            ...
            {
                _player = new Player(name, 120, 8, $"Titan[/]", 0, 0,2,1);
            ...
            {
                _player = new Player(name, 100, 5, "[bold chartreuse3]Rogue[/]", 0, 0,5,1);
            ...
            {
                _player = new Player(name, 75, 10, "[bold blueviolet]Warlock[/]", 0, 0,3,1);
